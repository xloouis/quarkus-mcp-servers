...
public class SharedApplication {
     ...
     * @param onArgsProcessed a function that will be called with the remaining arguments after the config source has been processed
     */
    public static void main(Class<? extends QuarkusApplication> app, String[] args, Function<List<String>, Void> onArgsProcessed) {
